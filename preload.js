...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onBuildComplete: (callback) => ipcRenderer.on('build-complete', (event, data) => callback(data)),
  onBuildError: (callback) => ipcRenderer.on('build-error', (event, data) => callback(data)),
});
